          ...
          <div class="container">
            ...
            <div class="content">
              ...
              <ul>
                ...
                ${role === 'PARTNER' ? '<li>Access your partner dashboard</li><li>Browse the exporter directory</li><li>Connect with exporters and buyers</li><li>Explore partnership opportunities</li>' : ''}
